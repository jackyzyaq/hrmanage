...
public class BreakTimeInfoHistory {

   private Integer id;
   private Integer breaktime_info_id;
   ...
   public Integer getBreaktime_info_id() {
      return this.breaktime_info_id;
   }

   public void setBreaktime_info_id(Integer breaktime_info_id) {
      this.breaktime_info_id = breaktime_info_id;
   }
}
