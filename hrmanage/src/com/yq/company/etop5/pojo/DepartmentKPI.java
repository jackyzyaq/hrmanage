...
public class DepartmentKPI extends VO {

   private Integer id;
   private String plant_kpi_type;
   private String plant_dept_name;
   private String plant_kpi_ext_1;
   private String plant_kpi_ext_2;
   ...
   public String getPlant_kpi_type() {
      return this.plant_kpi_type;
   }

   public void setPlant_kpi_type(String plant_kpi_type) {
      this.plant_kpi_type = plant_kpi_type;
   }

   public String getPlant_dept_name() {
      return this.plant_dept_name;
   }

   public void setPlant_dept_name(String plant_dept_name) {
      this.plant_dept_name = plant_dept_name;
   }

   public String getPlant_kpi_ext_1() {
      return this.plant_kpi_ext_1;
   }

   public void setPlant_kpi_ext_1(String plant_kpi_ext_1) {
      this.plant_kpi_ext_1 = plant_kpi_ext_1;
   }

   public String getPlant_kpi_ext_2() {
      return this.plant_kpi_ext_2;
   }

   public void setPlant_kpi_ext_2(String plant_kpi_ext_2) {
      this.plant_kpi_ext_2 = plant_kpi_ext_2;
   }
