...
<%
	...
	BreakTimeInfo si = new BreakTimeInfo();
	si.setWo_number(wo_number);
	si.setAvailable(1);
	List<BreakTimeInfo> list = breakTimeInfoService.findByCondition(si, null);
...
<body>
	<div id="contentwrapper" class="contentwrapper" style="width:90%;">
		<form class="stdform stdform2" onSubmit="return false;">
			<div class="widgetbox">
			    <div class="title"><h3>休假列表</h3></div>
