...
<script type="text/javascript" src="${ctx }/faurecia/common/service/breaktime/js/breaktime_batch.js"></script>
...
<body>
	<div id="contentwrapper" class="contentwrapper" style="width:90%;">
		<form class="stdform stdform2" onSubmit="return false;">
					        ...
					        <tr>
					        	...
					        	<td>
					        		<jsp:include page="/share/jsp/employee_ztree_checkbod.jsp" >
					        			...
					        			<jsp:param value="<%=employeeInfo.getZh_name() %>" name="emp_name"/>
					        		</jsp:include>
					        	</td>
			...
			<button id="batchSubmit" class="submit radius2">提交</button>
			</div>
		</form>
	</div>
</body>
