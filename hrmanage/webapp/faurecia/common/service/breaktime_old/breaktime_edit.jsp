...
$(function(){
	...
	classIn(<%=oti.getClass_id()%>,'<%=sdf.format(oti.getClass_date())%>');
});
...
<body>
	<div id="contentwrapper" class="contentwrapper" style="width:90%;">
		<form class="stdform stdform2" onSubmit="return false;">
					...
					<div class="widgetcontent padding0 statement">
				   		<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
					        ...
					        <tr>
					        	...
					        	<td>
					        		<input class="Wdate" type="text" title="开始时间" readonly="readonly" id="begin_date" name="begin_date" value="<%=sdf1.format(oti.getBegin_date()) %>"  onclick="wdateTimeInstance();" onblur="checkTime();"/>
					        	</td>
					        	<td style="font-weight:bold" align="center">休假时数</td>
					        	<td>
					        		<input type="text" title="休假时数" name="break_hour" id="break_hour" class="smallinput" value="<%=oti.getBreak_hour() %>" onblur="replaceForHalf(this);checkTime();"  onafterpaste="replaceForHalf(this);"/>&nbsp; 小时
					        	</td>
					        	<td style="font-weight:bold" align="center">结束时间</td>
					        	<td>
					        		<input class="Wdate" type="text" title="结束时间" readonly="readonly" id="end_date" name="end_date" value="<%=sdf1.format(oti.getEnd_date()) %>" />
					        	</td>
					        </tr>
					        <tr>
            ...
            <input type="hidden" id="tmpyear" value="<%=oti.getYear()%>"/>
