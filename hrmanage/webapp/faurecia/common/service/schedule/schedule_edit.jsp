...
<%
	...
	ScheduleInfo oti = scheduleInfoService.queryById(id, null);
...
function planOut(obj_id){
	var _url = ctx+'/common/scheduleInfo/queryResult.do';
	var param = {};
	param['id']=obj_id;
	ajaxUrl(_url,param,function(json){
		$.each(json.rows, function (n, value) {
...
function planInSub(obj){
	...
	ajaxUrl(_url,param,function(json){
        ...
        $("#remark").val("<%=StringUtils.defaultIfEmpty(oti.getRemark(), "")%>");
	});
}
</script>
...
<body>
	<div id="contentwrapper" class="contentwrapper" style="width:90%;">
		<form class="stdform stdform2" onSubmit="return false;">
            ...
            <input type="hidden" id="emp_id" name="emp_id" value="<%=oti.getEmp_id()%>"/>
