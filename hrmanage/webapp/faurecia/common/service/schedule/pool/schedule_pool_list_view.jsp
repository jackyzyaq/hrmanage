...
<%
	...
	ScheduleInfoPoolService scheduleInfoService = (ScheduleInfoPoolService) ctx.getBean("scheduleInfoPoolService");
	...
	si.setAvailable(1);
	List<ScheduleInfoPool> list = scheduleInfoService.findPoolByCondition(si, null);
			            ...
			            <tbody>
			            	...
			            	if(list!=null&&list.size()>0){ 
			            		for(int i=0;i<list.size();i++){
			            			ScheduleInfoPool bti = list.get(i);
			            	%>
			            	<tr>
			                    <td><%=(i+1) %></td>
