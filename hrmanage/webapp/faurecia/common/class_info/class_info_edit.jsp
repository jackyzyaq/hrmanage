...
$(function(){
	var params = {};
	params['class_name']='<%=Util.replaceD(mi.getClass_name())%>';
...
<body>
	<div id="contentwrapper" class="contentwrapper" style="width:90%;">
		<form class="stdform stdform2" onSubmit="return false;">
					...
					<div class="widgetcontent padding0 statement">
				   		<table id="class_info_table" cellpadding="0" cellspacing="0" border="0" class="stdtable">
					        ...
					        <tr>
					        	...
					        	<td>
					        		<input type="text" title="用餐时间" name="have_meals" readonly="readonly" id="have_meals" class="smallinput" value="<%=mi.getHave_meals() %>" onkeyup="replaceForNum(this);" onblur="replaceForNum(this);checkTime();"  onafterpaste="replaceForNum(this);"/>&nbsp; 分钟
					        	</td>
            ...
            <div>
            	<input type="hidden" name="meals" id="meals" value="<%=StringUtils.defaultIfEmpty(mi.getMeals(),"") %>" />
	            <button id="editSubmit" class="submit radius2">提交</button>
                <input type="reset" class="reset radius2" value="Reset" />
                <input type="hidden" name="id" id="id" value="<%=mi.getId()%>"/>
			</div>
		</form>
	</div>
</body>
