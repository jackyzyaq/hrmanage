...
$(function(){
	...
	params['parent_div']='#leave_use #search';
	inner_html(ctx+'/share/jsp/auto_employee.jsp',params,'leave_use #auto_emp',null);
	$("#leave_use #searchBtn").click(function(){
		leave_use_inner();
	});
	leave_use_inner();
});
function leave_use_inner(){
	var params = {};
	params['emp_id']=$("#leave_use #search #emp_id").val();
	inner_html(ctx+'/faurecia/common/quick_model/leave_use_inner.jsp',params,'leave_use_inner',null);
}
</script>
<div class="widgetbox">
	<div class="title">
