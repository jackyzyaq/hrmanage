...
<body>
	<div id="contentwrapper" class="contentwrapper">
		...
		$(function(){
			fes_inner('<%=begin_month%>','<%=end_month%>');
		});
		function fes_inner(begin_month,end_month){
			var params = {};
			params['begin_month']=begin_month;
			params['end_month']=end_month;
			params['menu_id']=<%=menu_id%>;
			inner_html(ctx+'/faurecia/ETOP5/number/fes_inner.jsp',params,'contentwrapper #fes_inner',null);
		}
		</script>
		<div class="widgetbox">
			<div class="title" style="float: right">
				<h4>
				<input style="width: 60px;" title="月份" type="text" readonly="readonly" id="begin_month" name="begin_month" value="<%=begin_month %>"  onclick="wdateYearMonthInstance('begin_month',function(){if($('#begin_month').val().Trim()==''){return false;}getEndMonthFn1();fes_inner($('#begin_month').val(),$('#end_month').val());});"/>
				~
