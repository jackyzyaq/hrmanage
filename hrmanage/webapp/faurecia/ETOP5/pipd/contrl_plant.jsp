	...
	<div id="contentwrapper" class="contentwrapper widgetpage">
		...
		<div class="widgetbox">
			<div class="title" style="float: right">
				<h4>
				<input style="width: 60px;" type="text" readonly="readonly" id="year" name="year" value="<%=year %>"  onclick="wdateYearMonthInstance('year',function(){if($('#year').val().Trim()==''){return false;}contrl_plan_inner($('#year').val());});"/>
				&nbsp;|&nbsp;
