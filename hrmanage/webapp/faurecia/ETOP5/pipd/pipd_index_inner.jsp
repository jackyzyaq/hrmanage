	...
	<div id="contentwrapper">
		<div class="widgetbox">
			<div class="title">
				...
				&nbsp;|&nbsp;
				<%=(begin_month+"~"+end_month)%>&nbsp;月&nbsp;&nbsp;&nbsp;[<a id="add_data" style="cursor:pointer;font-size:20px;" onclick="validateEtopPwd('${ctx}/faurecia/ETOP5/pipd/data/pipd_data_add.jsp?menu_id=<%=menu_id %>','PlantImprovementPlanDeployment');">&nbsp;+&nbsp;</a>]
				</h4>
			</div>
	...
	function load(){
		...
		$.each(valForm,function(i,v){
			if(i==0||i%(pip_column.length+1)==0){
				...
				var _title =	(
								//sub_type=='<%=Global.pip_head[0].replace("<br/>","")%>'?
								//	""
								//	:
