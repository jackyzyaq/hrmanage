...
<%
	...
	Map<String,List<GapKPI>> qcdpMap = new HashMap<String,List<GapKPI>>();
	for(String ext_2:Global.gap_kpi_qcdp){
		//qcdpMap.put(ext_2, gapKPIService.queryKPITypeByQCDP(ext_2));
	}
	//查询所有部门
				...
				<tbody>
					<%
						for (String ext_2:qcdpMap.keySet()) {
							List<GapKPI> pkList = qcdpMap.get(ext_2);
							int row = 0;
					...
					<tr>
						...
						<%
							for (GapKPI dpk : deptList) {
								pk = gapKPIService.queryByType(
											sdf.parse(kpi_date), 
