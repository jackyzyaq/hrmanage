...
%>
			       ...
			       <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
			            ...
			            <thead>
			                <tr>
			                    ...
			                    <th class="head0" style="width:10%">日期</th>
			                    <th class="head0" style="width:10%">部门</th>
			                    <th class="head0" style="width:8%">Input Or<br/>Output</th>
			                    <th class="head0" style="width:6%">TARGET</th>
			                    <th class="head0" style="width:6%">ACTUAL</th>
			                    <th class="head0" style="width:8%">正向<br/>反向</th>
			                    <th class="head0" style="width:8%">是否<br/>达标</th>
			                    <th class="head0" style="width:6%">QCDP</th>
		...
		function loadKPIList(){
			var _url = ctx+"/common/plantKPI/queryResult.do";
			var param = {};
			...
			ajaxUrl(_url,param,function(json){
				...
				$.each(json.rows, function (n, value) { 
					_tr_td += "<tr id='plant_kpi_"+value.id+"' onclick='plant_kpi_click_select(this);' title='点击可修改'>"+
		        ...
		        $("#plant_kpi_view table tbody").append(_tr_td);
		        _p_index++;
			});
		}
		loadKPIList();
		
		function plant_kpi_click_select(obj){
