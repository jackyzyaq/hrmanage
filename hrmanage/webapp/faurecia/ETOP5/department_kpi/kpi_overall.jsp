...
<script type="text/javascript">
	...
	function kpi_overall_inner(){
		...
		var _url = ctx+'/faurecia/ETOP5/department_kpi/kpi_overall_inner.jsp';
		var params = {};
					...
					<div style="margin-left: 0px;margin-bottom:10px;" >
						<div class="one_hlaf">
							<div style="float: left">
								<h4><font style="color: <%=Global.colors[3]%>"><%=Global.department_kpi_io[1]%></font></h4>
							</div>
						</div>		
						<div class="one_hlaf last">
							<div style="float: right">
								...
								&nbsp;|&nbsp;
								[<a id="add_data" style="cursor:pointer;font-size:20px;" onclick="validateEtopPwd('${ctx}/faurecia/ETOP5/department_kpi/data/department_kpi_data_add.jsp?menu_id=<%=menu_id %>','KPI 数据添加');">&nbsp;+&nbsp;</a>]
								&nbsp;|&nbsp;
