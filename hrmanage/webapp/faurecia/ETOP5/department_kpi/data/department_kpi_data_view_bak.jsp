...
%>
		...
		function loadKPIList(){
			var _url = ctx+"/common/departmentKPI/queryResult.do";
			var param = {};
			...
			ajaxUrl(_url,param,function(json){
				...
				$.each(json.rows, function (n, value) { 
					_tr_td += "<tr id='department_kpi_"+value.id+"' onclick='department_kpi_click_select(this);' title='点击可修改'>"+
		        ...
		        $("#department_kpi_view table tbody").append(_tr_td);
		        _p_index++;
			});
		}
		loadKPIList();
		...
		function exportKPIList(){
			var _url = ctx+"/common/departmentKPI/exportCsv.do";
			var param = {};
			downFile(_url,param);
		}
		
		function department_kpi_click_select(obj){
