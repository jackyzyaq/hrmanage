...
<%
	...
	List<DepartmentKPI> kpiList = departmentKPIService.queryKPIType();
	if(kpiList!=null&&!kpiList.isEmpty()){
		for(DepartmentKPI pk : kpiList){
			kpiStr += pk.getKpi_type()+"|";
		}
		kpiStr.substring(0,kpiStr.length()-1);
	}
%>
<form id="department_kpi_target_form" class="stdform" onSubmit="return false;">
			...
			<tr>
	         ...
	         <tr>
	         	<td colspan="6">
		         	...
		         	<input type="hidden" id="plant_kpi_ext_1" name="plant_kpi_ext_1" value="-"/>
		         	<input type="hidden" id="plant_kpi_ext_2" name="plant_kpi_ext_2" value="-"/>
		         	<input type="hidden" id="plant_kpi_type" name="plant_kpi_type" value="-"/>
					<input type="hidden" id="plant_dept_name" name="plant_dept_name" value="-"/>
