	function load_kpi_data(kpi_div_id,day_or_month,d1,d2,d3,content,colors,unit){
		...
		$.plot($("#"+kpi_div_id+""), [ 
			{data:d2,color: colors[0],bars:  {show: true,   align: "left", barWidth: 0.6,  lineWidth:1,numbers: {show: function(s){return s;}}}},//"达标"
			{data:d3,color: colors[1],bars:  {show: true,   align: "left", barWidth: 0.6,  lineWidth:1,numbers: {show: function(s){return s;}}}},//"未达标"
