...
<script type="text/javascript">
	...
	function loadTab(tab,_fn){
		...
		var url = '';
		if(tab=='tabs-1'){
			url = (ctx+'/faurecia/ETOP5/tour/data/tour_info_add_inner.jsp?menu_id=<%=menu_id%>');
		}else if(tab=='tabs-2'){
			url = (ctx+'/faurecia/ETOP5/tour/data/tour_info_data_view.jsp?menu_id=<%=menu_id%>');
		}
		if(url!='')
	...
	function tourIn(tourId){
		var _url = ctx+'/common/tour/queryResult.do';
		var param = {};
		param['pageIndex']=1;
		param['pageSize']=10;
		param['id']=tourId;
