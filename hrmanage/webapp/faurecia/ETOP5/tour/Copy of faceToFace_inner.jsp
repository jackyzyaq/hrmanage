		...
		<div  class="shadowdiv" style="margin:5px;">
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
				...
				<thead>
					...
					<tr>
		            	<th class="head0" ><a style="cursor:pointer" >Stop</a></th>
		               	<th class="head0" ><a style="cursor:pointer" >Situation</a></th>
		               	<th class="head0" ><a style="cursor:pointer" >Action</a></th>
		               	<th class="head0" ><a style="cursor:pointer" >Status</a></th>
					</tr>
				</thead>
				<tbody>
				<%if(tourList!=null&&!tourList.isEmpty()){ 
					for(Tour tour:tourList){
						...
						if(tour.getDept_id_1().intValue()==dept_id){
						...
						}else if(tour.getDept_id_2().intValue()==dept_id){
