	function load_kpi_data(kpi_div_id,day_or_month,d1,d2,d3,content,colors,unit){
		...
		$.plot($("#"+kpi_div_id+""), [ 
			{data:d1,color: colors[0],
				lines: {show:true,fill: false, steps: false},points: {fillColor: colors[0], show: true }} ,
			{data:d2,color: colors[1],
				lines: {show:true,fill: false, steps: false},points: {fillColor: colors[1], show: true }} ,
			{data:d3,color: colors[2],
